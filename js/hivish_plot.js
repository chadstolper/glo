var hivish_plot = function(){
  ...
  setTimeout(function(){ position_theta_by_property("generation") }, transition_duration*6);
  setTimeout(function(){ position_radius_by_property("degree") }, transition_duration*7);
  setTimeout(function(){ select_generation(3) }, transition_duration*8);
  setTimeout(function(){ position_theta_by_property("generation") }, transition_duration*9);
  setTimeout(function(){ position_radius_by_property("modularity_class") }, transition_duration*10);
  setTimeout(function(){ select_generation(2) }, transition_duration*11);
  setTimeout(function(){ position_theta_by_property("generation") }, transition_duration*12);
  setTimeout(function(){ position_radius_by_property("page_rank") }, transition_duration*13);
  setTimeout(function(){ select_generation(1) }, transition_duration*14);
  setTimeout(function(){ position_theta_by_property("generation") }, transition_duration*15);
  setTimeout(function(){ position_radius_by_property("betweenness_centrality") }, transition_duration*16);
  setTimeout(function(){ select_generation(0) }, transition_duration*17);
  setTimeout(function(){ position_theta_by_property("generation") }, transition_duration*18);
  setTimeout(function(){ position_radius_by_property("id") }, transition_duration*19);
    setTimeout(function(){ transition_links_to_curved() }, transition_duration*20);
